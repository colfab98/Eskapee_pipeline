...
# 4) confirm bacass assets & unicycler pin (warn-only)
...
# 7b) require minigraph in the project env
...
# 7) write offline env exports (absolute project-local cache path)
